...
1. 이슈의 변경 스펙과 ThreadVault의 현재 동작 기획서를 읽고, 엣지케이스와 애매한 구현 방향을 정리해서 사람에게 확인을 요청하세요. 미구현 스펙과 테스트 목표는 이슈에서 관리하며, 기획서는 구현·검증 후 리드가 갱신합니다.
...
8. 기본적으로 주석을 작성하지 않습니다. 숨겨진 제약, 비직관적 동작, 특정 버그 우회처럼 미래 개발자가 보면 놀랄 내용에만 한 줄 주석을 추가합니다. "무엇을 하는지"가 아니라 "왜 이렇게 해야 하는지"만 씁니다.
